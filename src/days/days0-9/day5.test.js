...
xdescribe("day5 test runs", () => {
  test("day 5 test", () => {
    const result = day5(readFile("days0-9/day5-test1"), 1);
    expect(result).toStrictEqual('CMZ');
  });
  test("day 5 test part 2", () => {
    const result = day5(readFile("days0-9/day5-test1"), 2);
...
xdescribe("day5 answer", () => {
  test("day 5 answer", () => {
    const result = day5(readFile("days0-9/day5"), 1);
    expect(result).toStrictEqual('RLFNRTNFB');
  });
  test("day 5 answer part 2", () => {
    const result = day5(readFile("days0-9/day5"), 2);
