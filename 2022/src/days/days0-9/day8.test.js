...
xdescribe("day8 test runs part 1", () => {
  ...
  test("day 8 part 1 test 1", () => {
    const result = day8(readFile("days0-9/day8-test"), 1);
    expect(result).toStrictEqual(21);
  });

  test("day 8 part 2", () => {
    const result = day8(readFile("days0-9/day8-test"), 2);
...
xdescribe("day8 answer", () => {
    ...
    test("day 8 part 1 answer", () => {
      const result = day8(readFile("days0-9/day8"), 1);
      expect(result).toStrictEqual(1736);
    });
  
    test("day 8 part 2", () => {
      const result = day8(readFile("days0-9/day8"), 2);
